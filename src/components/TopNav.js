...
function TopNav() {
  ...
  <a href="#" class="flex">
      ...
      <span class="self-center text-lg font-semibold whitespace-nowrap dark:text-white">JT Store</span>
  </a>
  <div class="flex items-center md:order-2">
      ...
      <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown">
        ...
        <li>
          <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Cart</a>
        </li>
        </ul>
  ...
  <a href="#" role="button" class="relative flex flex-end">
